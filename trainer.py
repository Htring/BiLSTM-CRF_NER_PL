...
def model_use(param):
    ...
    model = BiLSTMCRF.load_from_checkpoint(param.ckpt_path, hparams=param)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--ckpt_path", type=str, default="model_save/ner-epoch=298-val_f1=0.918.ckpt")
